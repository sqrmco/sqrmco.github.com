...
var BackgroundImage = function () {
  function BackgroundImage() {
    ...
    this.uniforms = {
      ...
      imageResolution: {
        type: 'v2',
        value: new THREE.Vector2(1161, 338)
      },
      texture: {
        type: 't',
        value: null
...
var ConsoleSignature = function () {
  function ConsoleSignature() {
    ...
    this.message = 'created by jens fursund';
    this.url = 'sqrm.co';
    this.show();
  }
...
var cameraBack = new THREE.PerspectiveCamera(45, window.innerWidth / window.innerHeight, 1, 1);
